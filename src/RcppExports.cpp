...
RcppExport SEXP _nnspline_order_d_matrix(SEXP dSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _nnspline_order_adjacency_matrix(SEXP mSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _nnspline_lowest_k(SEXP dSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _nnspline_distance_matrix_to_dag(SEXP dSEXP, SEXP n_neighboursSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(distance_matrix_to_dag(d, n_neighbours));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_nnspline_order_d_matrix", (DL_FUNC) &_nnspline_order_d_matrix, 1},
    {"_nnspline_order_adjacency_matrix", (DL_FUNC) &_nnspline_order_adjacency_matrix, 1},
    {"_nnspline_lowest_k", (DL_FUNC) &_nnspline_lowest_k, 2},
    {"_nnspline_distance_matrix_to_dag", (DL_FUNC) &_nnspline_distance_matrix_to_dag, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_nnspline(DllInfo *dll) {
